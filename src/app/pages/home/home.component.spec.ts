...
import { ProductsService } from 'src/app/services/festivals/products.service';
...
import { IFestivals } from 'src/app/shared/utils/records.interface';
...
describe('HomeComponent', () => {
  ...
  it('should select item to be deleted', () => {
    const item: IFestivals = MOCK_RECORDS[0];
